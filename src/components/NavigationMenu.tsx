...
const navItems: NavItem[] = [
  {
    label: "WOMEN",
    href: "/ready-to-wear",
    image: "/images/0a47c57d-3c01-4b8d-923a-203df4bcc94f.png",
    subMenu: {
  ...
  },
  {
    label: "COLLECTIONS",
    href: "/collections",
    image: "/images/5e9a58ef-9472-43ca-b091-eccd77877cdc.png",
    subMenu: {
  ...
  },
  {
    label: "INSIDE ORMA",
    href: "/inside-orma",
    image: "/images/0d046df7-d859-48fb-8da4-3e46ed6a015f.png",
    subMenu: null,
  },
];
...
export default function NavigationMenu({ isOpen, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Right: menu panel */}
      <div className="w-[56%] h-full bg-white flex flex-col" style={{ fontFamily: "var(--font-body)" }}>
        {/* Top bar */}
        ...
        <div className="flex justify-between px-14 py-6 border-t border-gray-100">
          <Link href="/support" onClick={onClose} className="text-[11px] tracking-[0.06em] text-gray-400 hover:text-black transition-colors">
            Customer support
          </Link>
          <Link href="/appointment" onClick={onClose} className="text-[11px] tracking-[0.06em] text-gray-400 hover:text-black transition-colors">
            Book an appointment
          </Link>
        </div>
      </div>
